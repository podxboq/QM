...
Llamamos \define{función de onda} a las soluciones de la ecuación de Schrödinger. Diremos que $\Psi$ es una función de onda del potencial $V(x,t)$.

\begin{postulate}[Ecuación de Schrödinger en una dimensión]
    \begin{equation}
